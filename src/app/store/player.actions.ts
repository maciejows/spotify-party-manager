...
export const getLyrics = createAction('[Lyrics service] Get Lyrics', props<{artist: string, song: string}>());
export const getLyricsSuccess = createAction('[Lyrics service] Get Lyrics Success', props<{lyrics: string}>());
