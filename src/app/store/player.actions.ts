...
export const getLyrics = createAction('[Lyrics service] Get Lyrics', props<{artist: string, song: string, id: string}>());
export const getLyricsSuccess = createAction('[Lyrics service] Get Lyrics Success', props<{lyrics: string, id: string}>());
export const getLyricsError = createAction('[Lyrics service] Get Lyrics Error', props<{error: string}>());